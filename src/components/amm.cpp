...
void print_cp_amm(CP_AMM &a, std::vector<Token> &_tokens)
{
    ...
    std::cout << "Sell token index/alias:\t\t" << a.sell_token_index
              << " (" << _tokens[a.sell_token_index].alias << ')' << '\n';

    std::cout << "Sell amount:\t\t\t" << a.sell_reserve_amount << '\n';

    std::cout << "Buy token index/alias:\t\t" << a.buy_token_index << " ("
              << _tokens[a.buy_token_index].alias << ')' << '\n';
    ...
    std::cout << "    Cost token index/alias:\t" << a.cost_token_index
              << " (" << _tokens[a.cost_token_index].alias << ')' << '\n';
