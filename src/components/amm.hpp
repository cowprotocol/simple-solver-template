...
class CP_AMM {
    public:
        ...
        // Constructor
        CP_AMM(int _amm_index, int _sell_token_index, boost::multiprecision::mpz_int _sell_reserve_amount, int _buy_token_index, boost::multiprecision::mpz_int _buy_reserve_amount, boost::multiprecision::mpf_float _fee_fraction, int _cost_token_index, boost::multiprecision::mpz_int _cost_amount, bool _is_mandatory): amm_index(_amm_index), sell_token_index(_sell_token_index),  sell_reserve_amount(_sell_reserve_amount), buy_token_index(_buy_token_index), buy_reserve_amount(_buy_reserve_amount), fee_fraction(_fee_fraction), cost_token_index(_cost_token_index), cost_amount(_cost_amount), is_mandatory(_is_mandatory) {
        }
